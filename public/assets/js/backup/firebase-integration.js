...
class FirebaseIntegration {
    ...
    async init() {
        try {
            ...
            if (!firebase.apps.length) {
                ...
                console.log('[Firebase] Firebase initialized for:', this.config.projectId);
            }
    ...
    calculateStats(dataArray) {
        ...
        // Use new field name first, fallback to legacy name for compatibility
        const energies = dataArray.map(item => item.energi || item.energy || 0);
